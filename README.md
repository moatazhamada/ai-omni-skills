...
> **🎉 v1.5.0 is out — automatic pre-sync backups, session-aware consent, a smaller core CLI (`sync`, `setup`, `doctor`, `restore`, `update`, `help`), and secondary commands moved under `manage`. [Read the changelog →](CHANGELOG.md)**
