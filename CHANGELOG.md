...
### Fixed
- `lib/doctor.js`: Handle arrays in `skillsDir` (Kimi dual directory support) — `skills doctor` now works with the array format introduced in v1.2.1
...
- Weekly health check cron support (`skills doctor`)
